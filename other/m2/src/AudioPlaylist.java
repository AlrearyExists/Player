...
public class AudioPlaylist extends Application {
    private static final String MUSIC_DIR = "C:\\Users\\Wovch\\Desktop\\Player";
    public static final String TAG_COLUMN_NAME = "Tag";
    public static final String VALUE_COLUMN_NAME = "Value";
    public static final List<String> SUPPORTED_FILE_EXTENSIONS = Arrays.asList(".mp4", ".mpeg");
    ...
    public void start(final Stage stage) throws Exception {
        ...
        final Button skip = new Button("Start");
