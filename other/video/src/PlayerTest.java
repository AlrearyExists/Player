...
public class PlayerTest extends javax.swing.JFrame implements ActionListener, ControllerListener {
    ...
    private void getfile() { //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        try {
    ...
    private void createfile() { // throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        try {
